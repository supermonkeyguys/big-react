...
function prepareFreshWork(root: FiberRootNode, lane: Lane) {
...
function ensureRootIsScheduler(root: FiberRootNode) {
    ...
    if (updateLane === SyncLane) {
        ...
        scheduleSyncCallback(performSyncWorkRoot.bind(null, root, updateLane))
...
function performSyncWorkRoot(root: FiberRootNode, lane: Lane) {
    ...
    do {
        try {
            ...
            if (__DEV__) console.warn('workLoop 发生错误', e)
            workInProgress = null
        }
